...
HD_PWD='C:/Users/Muzaffer/Desktop/Class_project/Class_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTC_7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTC_7Seg.tcl
